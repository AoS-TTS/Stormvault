...
3. Drag/Extract the Stormvault folder from the Zip and place into your Saves folder in your Tabletop Simulator directory above. If updating, overwrite if prompted.
